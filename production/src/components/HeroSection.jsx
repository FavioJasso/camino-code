...
export default function HeroSection() {
  return (
    <main className="relative mx-auto flex min-h-[90vh] w-full items-center justify-center overflow-hidden bg-black">
      ...
      <div className="absolute top-20 left-20 h-96 w-96 rounded-full bg-gradient-to-t from-amber-400 to-red-600 opacity-20 blur-3xl animate-float"></div>
      <div className="absolute bottom-20 right-20 h-96 w-96 rounded-full bg-gradient-to-t from-amber-300 to-orange-500 opacity-20 blur-3xl animate-float-delayed"></div>
      ...
      <div className="relative z-10 container flex w-full max-w-7xl flex-col items-center justify-center gap-8 px-6 py-16 text-center md:px-10 md:py-20 lg:py-24">
        ...
        <div className="absolute top-0 -right-10 h-[250px] w-[250px] animate-spin-slow opacity-30 md:top-32 md:h-[318px] md:w-[315px]">
          <div className="absolute inset-0 bg-gradient-to-t from-amber-400 to-red-600 blur-2xl"></div>
          <Image
        ...
        <div className="absolute -bottom-10 -left-10 h-[250px] w-[250px] animate-spin-slow-reverse opacity-30 md:-bottom-16 md:-left-32 md:h-[540px] md:w-[540px]">
          <div className="absolute inset-0 bg-gradient-to-t from-amber-400 to-orange-600 blur-2xl"></div>
          <Image
      ...
      >
        ...
        <div className="absolute top-10 right-1/4 animate-bounce-slow animation-delay-200">
          <Sparkles className="h-6 w-6 text-amber-400 opacity-50" />
        </div>
        <div className="absolute bottom-10 left-1/3 animate-bounce-slow animation-delay-400">
          <Zap className="h-7 w-7 text-red-500 opacity-50" />
        </div>
        ...
        <div className="animate-fade-in-down mb-4">
          <div className="inline-flex items-center gap-2 rounded-full border border-orange-500/20 bg-gradient-to-t from-amber-950/50 to-orange-950/50 px-4 py-2 backdrop-blur-sm">
            ...
            <span className="text-sm font-medium text-orange-200">Innovating the Digital Future</span>
          </div>
        </div>
        ...
        <p className="animate-fade-in-up animation-delay-200 w-full max-w-3xl text-sm leading-relaxed font-medium text-gray-300 sm:text-base md:text-lg lg:text-xl lg:leading-[32px]">
          ...
          <span className="text-orange-400 font-semibold">data science</span> and{" "}
          <span className="text-amber-400 font-semibold">web development</span>{" "}
        ...
        <div className="animate-fade-in-up animation-delay-400 mt-8 flex flex-col items-center gap-4">
          ...
          >
            ...
            {/* Glow effect */}
            <div className="absolute inset-0 bg-gradient-to-t from-amber-400 to-red-600 opacity-50 blur-xl group-hover:opacity-70 transition-opacity duration-500"></div>
        ...
        <div className="animate-fade-in-up animation-delay-600 mt-16 flex flex-wrap items-center justify-center gap-8 opacity-50">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            <span className="text-gray-400 font-mono text-sm hover:text-orange-400 transition-colors">React</span>
            <span className="text-gray-400 font-mono text-sm hover:text-amber-400 transition-colors">Next.js</span>
            <span className="text-gray-400 font-mono text-sm hover:text-red-500 transition-colors">TypeScript</span>
            <span className="text-gray-400 font-mono text-sm hover:text-orange-500 transition-colors">Python</span>
          </div>
        </div>
      </section>
    </main>
