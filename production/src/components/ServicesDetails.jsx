...
// Custom hooks for mobile detection and reduced motion
const useIsMobile = () => {
    ...
    >
      ...
      >
        <div
          ...
          style={{
            backgroundImage: `radial-gradient(ellipse at ${index % 2 === 0 ? 'top left' : 'bottom right'}, rgba(251, 146, 60, 0.2) 0%, transparent 50%)`,
          }}
        />
      </motion.div>
