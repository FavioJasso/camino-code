        ...
        <div ref={containerRef} className="relative overflow-hidden bg-black">
          ...
          <section className="relative flex min-h-screen items-center justify-center">
            ...
            >
              ...
              >
                <span className="block text-white">TECHWAVE</span>
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          ...
          >
            <div className="text-center p-8">
              ...
              <p className="text-2xl font-bold text-gray-800">Data Analytics</p>
            </div>
          </motion.div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6">
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          ...
          >
            <div className="text-center p-8">
              <div className="text-6xl mb-4">🤖</div>
              <p className="text-2xl font-bold text-gray-800">ML Predictions</p>
            </div>
          </motion.div>
