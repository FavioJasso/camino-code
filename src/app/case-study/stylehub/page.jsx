...
const StyleHubCaseStudy = () => {
  ...
  const caseData = {
    ...
    subtitle:
      "Building a scalable web application that boosted online sales by 150%",
    heroImage: "/assets/images/services_work02.png",
    stats: [
      {
        value: "150%",
        ...
        <div ref={containerRef} className="relative overflow-hidden bg-black">
          ...
          <section className="relative flex min-h-screen items-center justify-center">
            ...
            >
              ...
              >
                <span className="block text-white">STYLEHUB</span>
      ...
      <div className="container mx-auto px-6">
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          ...
          >
            ...
            >
              <p>
                StyleHub's legacy platform struggled with scalability issues,
                slow page loads, and poor mobile experience. Their outdated
                architecture couldn't handle growing traffic and prevented them
                from implementing modern e-commerce features.
              </p>
              <ul className="space-y-4">
                {[
                  "7-second average page load time causing high bounce rates",
                  "Non-responsive design with poor mobile conversion",
                  "Unable to scale during peak shopping seasons",
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          ...
          >
            <div className="text-center p-8">
              ...
              <p className="text-2xl font-bold text-gray-800">Lightning Fast</p>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <p>
                We built a modern, headless e-commerce platform using Next.js,
                React, and cloud infrastructure. The new architecture provides
                blazing-fast performance, seamless scalability, and an
                exceptional user experience across all devices.
              </p>
              <ul className="space-y-4">
                {[
                  "Headless architecture with Next.js and React",
  ...
  const phases = [
    {
      ...
      duration: "6 weeks",
      description:
        "UX/UI design and architecture planning for optimal user experience",
      color: "from-orange-400 to-red-600",
    },
    {
      title: "Development",
      duration: "16 weeks",
      description: "Building the headless e-commerce platform with modern stack",
      color: "from-red-400 to-orange-600",
    },
    {
      title: "Migration",
      duration: "8 weeks",
      description: "Data migration and integration with existing systems",
      color: "from-orange-400 to-amber-600",
    },
    {
      title: "Launch & Scale",
      duration: "4 weeks",
      description: "Gradual rollout and performance optimization at scale",
        ...
        >
          ...
          >
            ...
            <p className="text-2xl font-light text-white/90 italic sm:text-3xl">
              The new platform exceeded all our expectations. Our sales tripled,
              page load times decreased by 70%, and customer satisfaction scores
              reached an all-time high. Camino Code delivered excellence.
            </p>
      ...
      <div className="container mx-auto px-6 text-center">
        ...
        >
          ...
          <h3 className="mb-8 text-3xl font-bold text-white sm:text-4xl">
            AI-Powered Chatbot for FinServe
          </h3>
          <a href="/case-study/finserve">
            <motion.button
...
export default StyleHubCaseStudy;
