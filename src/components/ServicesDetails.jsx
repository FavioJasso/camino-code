    ...
    <div className="flex w-full flex-col items-center justify-center text-center text-white">
      ...
      >
        <div className="relative mx-auto flex w-full max-w-[1440px] flex-col md:min-h-screen md:flex-row">
          <div className="sticky-content w-full gap-8 text-left md:sticky md:top-0 md:h-screen md:w-1/2 md:p-12 md:pt-24">
          ...
          <div className="scroll-content flex w-full flex-col gap-6 text-left md:w-1/2 md:p-12 md:pt-24 [&>div]:flex [&>div]:flex-col [&>div]:gap-4 [&>div]:rounded-xl [&>div]:bg-black [&>div]:p-10">
      ...
      >
        <div className="relative mx-auto flex w-full max-w-[1440px] flex-col md:min-h-screen md:flex-row">
          ...
          <div className="scroll-content flex w-full flex-col gap-6 text-left md:w-1/2 md:p-12 md:pt-24 [&>div]:flex [&>div]:flex-col [&>div]:gap-4 [&>div]:rounded-xl [&>div]:bg-[rgba(236,234,232,1)] [&>div]:p-10">
            <div className="transition-all duration-300 hover:scale-[1.02]">
              <span className="inline-block h-9 w-9 text-orange-400">
                <Laptop className="h-full w-full" />
              </span>
