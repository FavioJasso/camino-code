...
export default function ServicesSection() {
  return (
    <section
      id="services"
      className="flex h-auto flex-col items-center px-6 py-16 sm:px-8 sm:py-20 md:items-start md:px-10 lg:px-12 container mx-auto"
    >
      {/* Section Heading */}
      <motion.h2
      ...
      <div className="mt-10 grid w-full grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {services.map((service, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            whileHover={{ y: -5 }}
            className="flex flex-col gap-6 rounded-xl bg-[rgba(236,234,232,1)] p-6 "
          >
            {/* Service Icon */}
